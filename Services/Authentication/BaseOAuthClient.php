...
/**
 * A base class for various types of OAuth services
 *
 * @package DreamFactory\Platform\Services\Authentication
 */
abstract class BaseOAuthClient extends BaseProxyService implements ConsumerLike
{
	//**************************************************************************
	//* Constants
	//**************************************************************************
	...
	public function __construct( $options = array() )
	{
		...
		{
			throw new \InvalidArgumentException( 'You must specify a unique value for the "appName" property in order to use this object.' );
		}
	...
	{
		$_code = FilterInput::get( INPUT_GET, 'code', FILTER_SANITIZE_STRING );
