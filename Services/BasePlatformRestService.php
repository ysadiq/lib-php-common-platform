...
abstract class BasePlatformRestService extends BasePlatformService implements RestServiceLike
{
    ...
    public function trigger( $eventName, $eventData = null )
    {
        ...
        $_event = new ResourceEvent( $this->_action, $this->_resource, $this->_requestPayload, $this->_response, $eventData );

        return parent::trigger( $_name, $_event );
    }
