    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'nickname'         => 'getUsers',
                'type'             => 'UsersResponse',
                'event_name'       => '{api_name}.users.list',
            ...
            array(
                ...
                'type'             => 'UsersResponse',
                'event_name'       => '{api_name}.users.create',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'UsersResponse',
                'event_name'       => '{api_name}.users.update',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'UsersResponse',
                'event_name'       => '{api_name}.users.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'ids',
    ...
    array(
        ...
        'operations'  => array(
            ...
            array(
                ...
                'nickname'         => 'updateUser',
                'type'             => 'UserResponse',
                'event_name'       => '{api_name}.user.update',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'nickname'         => 'deleteUser',
                'type'             => 'UserResponse',
                'event_name'       => '{api_name}.user.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
