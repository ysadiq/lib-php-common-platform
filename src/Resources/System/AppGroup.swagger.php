    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'event_name'       => '{api_name}.groups.list',
            ...
            array(
                ...
                'type'             => 'AppGroupsResponse',
                'event_name'       => '{api_name}.groups.create',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'AppGroupsResponse',
                'event_name'       => '{api_name}.groups.update',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'AppGroupsResponse',
                'event_name'       => '{api_name}.groups.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'ids',
    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'event_name'       => '{api_name}.group.read',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'type'             => 'AppGroupResponse',
                'event_name'       => '{api_name}.group.update',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'type'             => 'AppGroupResponse',
                'event_name'       => '{api_name}.group.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
