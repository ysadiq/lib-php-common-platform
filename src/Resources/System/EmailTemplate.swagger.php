    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'event_name'       => '{api_name}.templates.read',
            ...
            array(
                ...
                'type'             => 'EmailTemplatesResponse',
                'event_name'       => '{api_name}.templates.create',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'EmailTemplatesResponse',
                'event_name'       => '{api_name}.templates.update',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'EmailTemplatesResponse',
                'event_name'       => '{api_name}.templates.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'ids',
    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'event_name'       => '{api_name}.template.read',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'type'             => 'EmailTemplateResponse',
                'event_name'       => '{api_name}.template.update',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'type'             => 'EmailTemplateResponse',
                'event_name'       => '{api_name}.template.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
