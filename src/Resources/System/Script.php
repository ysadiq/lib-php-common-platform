...
class Script extends BaseSystemRestResource
{
     ...
     * @return mixed
     */
    protected static function getScriptEngine( $data = array(), $key = 'script_data' )
    {
        if ( null === static::$_scriptEngine )
        {
            //  Create the engine...
            static::$_scriptEngine = new \V8Js();
        }
     ...
     * @return string
     */
    public static function enrobeScript( $script, $data = array() )
    {
        $_eventData = json_encode( $data, JSON_UNESCAPED_SLASHES );
...
_result = _processPlatformEvent(_event);
