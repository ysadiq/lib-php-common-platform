...
class Script extends BaseSystemRestResource
{
    ...
    public static function runScript( $scriptName, $scriptId = null, array &$data = array(), &$output = null )
    {
        ...
        try
        {
            ...
            $_runnerShell = static::enrobeScript( $_script );
            ...
            $data = $_runner->executeString( $_runnerShell, $scriptId, \V8Js::FLAG_FORCE_ARRAY ); //, static::$_scriptTimeout );
            $output = ob_get_clean();
...
_result = (function(event, eventData) {
