    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'nickname'         => 'getRoles',
                'type'             => 'RolesResponse',
                'event_name'       => '{api_name}.roles.list',
            ...
            array(
                ...
                'type'             => 'RolesResponse',
                'event_name'       => '{api_name}.roles.create',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'RolesResponse',
                'event_name'       => '{api_name}.roles.update',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'RolesResponse',
                'event_name'       => '{api_name}.roles.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'ids',
    ...
    array(
        ...
        'operations'  => array(
            ...
            array(
                ...
                'nickname'         => 'updateRole',
                'type'             => 'RoleResponse',
                'event_name'       => '{api_name}.role.update',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'nickname'         => 'deleteRole',
                'type'             => 'RoleResponse',
                'event_name'       => '{api_name}.role.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
