    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'nickname'         => 'getApps',
                'type'             => 'AppsResponse',
                'event_name'       => array( '{api_name}.apps.list' ),
            ...
            array(
                ...
                'nickname'         => 'createApps',
                'type'             => 'AppsResponse',
                'event_name'       => array( '{api_name}.apps.create' ),
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'nickname'         => 'updateApps',
                'type'             => 'AppsResponse',
                'event_name'       => array( '{api_name}.apps.update' ),
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'nickname'         => 'deleteApps',
                'type'             => 'AppsResponse',
                'event_name'       => array( '{api_name}.apps.delete' ),
                'parameters'       => array(
                    array(
                        'name'          => 'ids',
    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'nickname'         => 'getApp',
                'type'             => 'AppResponse',
                'event_name'       => array( '{api_name}.app.read' ),
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'nickname'         => 'updateApp',
                'type'             => 'AppResponse',
                'event_name'       => array( '{api_name}.app.update' ),
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'nickname'         => 'deleteApp',
                'type'             => 'AppResponse',
                'event_name'       => array( '{api_name}.app.delete' ),
                'parameters'       => array(
                    array(
                        'name'          => 'id',
