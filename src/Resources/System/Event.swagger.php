    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'nickname'         => 'getEvents',
                'type'             => 'EventsResponse',
                'event_name'       => '{api_name}.events.list',
            ...
            array(
                ...
                'type'             => 'EventsResponse',
                'event_name'       => '{api_name}.events.create',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'EventsResponse',
                'event_name'       => '{api_name}.events.update',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'EventsResponse',
                'event_name'       => '{api_name}.events.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'ids',
    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'nickname'         => 'getEvent',
                'type'             => 'EventResponse',
                'event_name'       => '{api_name}.event.read',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'type'             => 'EventResponse',
                'event_name'       => '{api_name}.event.update',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'type'             => 'EventResponse',
                'event_name'       => '{api_name}.event.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
