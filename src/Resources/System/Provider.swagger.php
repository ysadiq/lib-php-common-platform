    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'event_name'       => '{api_name}.providers.list',
            ...
            array(
                ...
                'type'             => 'ProvidersResponse',
                'event_name'       => '{api_name}.providers.create',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'ProvidersResponse',
                'event_name'       => '{api_name}.providers.update',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'ProvidersResponse',
                'event_name'       => '{api_name}.providers.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'ids',
    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'event_name'       => '{api_name}.provider.read',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'type'             => 'ProviderResponse',
                'event_name'       => '{api_name}.provider.update',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'type'             => 'ProviderResponse',
                'event_name'       => '{api_name}.provider.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
