    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'event_name'       => '{api_name}.services.list',
            ...
            array(
                ...
                'type'             => 'ServicesResponse',
                'event_name'       => '{api_name}.services.create',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'ServicesResponse',
                'event_name'       => '{api_name}.services.update',
                'consumes'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'produces'         => array( 'application/json', 'application/xml', 'text/csv' ),
                'parameters'       => array(
                    array(
            ...
            array(
                ...
                'type'             => 'ServicesResponse',
                'event_name'       => '{api_name}.services.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'ids',
    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'event_name'       => '{api_name}.service.read',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'type'             => 'ServiceResponse',
                'event_name'       => '{api_name}.service.update',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
            ...
            array(
                ...
                'type'             => 'ServiceResponse',
                'event_name'       => '{api_name}.service.delete',
                'parameters'       => array(
                    array(
                        'name'          => 'id',
