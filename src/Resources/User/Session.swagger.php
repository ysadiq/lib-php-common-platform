    ...
    array(
        ...
        'operations'  => array(
            array(
                ...
                'nickname'         => 'getSession',
                'event_name'       => array( '{api_name}.session.read', SessionEvents::REFRESH ),
                'type'             => 'Session',
                'responseMessages' => SwaggerManager::getCommonResponses( 401, 500 ),
            ...
            array(
                ...
                'nickname'         => 'login',
                'type'             => 'Session',
                'event_name'       => array( '{api_name}.session.create', SessionEvents::USER_LOGIN ),
                'parameters'       => array(
                    array(
                        'name'          => 'body',
                ...
                'responseMessages' => SwaggerManager::getCommonResponses( 400, 500 ),
            ...
            array(
                ...
                'nickname'         => 'logout',
                'type'             => 'Success',
                'event_name'       => array( '{api_name}.session.delete', SessionEvents::USER_LOGOUT ),
                'responseMessages' => SwaggerManager::getCommonResponses( 500 ),
