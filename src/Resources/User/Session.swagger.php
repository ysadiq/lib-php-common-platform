...
/**
 * user.session swagger definitions
 */
return array(
        ...
        array(
            ...
            'operations'  => array(
                array(
                    ...
                    'nickname'         => 'getSession',
                    'event_name'       => array( '{api_name}.session.read', 'user.session.reload' ),
                    'type'             => 'Session',
                ...
                array(
                    ...
                    'nickname'         => 'login',
                    'type'             => 'Session',
                    'event_name'       => array( '{api_name}.session.create', 'user.session.login' ),
                    'parameters'       => array(
                        array(
                            'name'          => 'body',
                ...
                array(
                    ...
                    'nickname'         => 'logout',
                    'type'             => 'Success',
                    'event_name'       => array( '{api_name}.session.delete', 'user.session.logout' ),
                    'responseMessages' => array(
                        array(
                            'message' => 'System Error - Specific reason is included in the error message.',
                            'code'    => 500,
